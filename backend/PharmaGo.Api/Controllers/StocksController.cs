...
public class StocksController(IApplicationDbContext context, ICurrentUserService currentUserService) : ControllerBase
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return CreatedAtAction(nameof(GetByPharmacy), new { pharmacyId = stockItem.PharmacyId }, new StockItemResponse
        {
            Id = stockItem.Id,
