...
namespace PharmaGo.IntegrationTests.Audit;

public class AuditLogsAccessTests(CustomWebApplicationFactory factory) : IClassFixture<CustomWebApplicationFactory>, IAsyncLifetime
{
    ...
    [Fact]
    public async Task Pharmacist_ShouldNotReadAuditLogsWithoutAssignedPharmacy()
    {
