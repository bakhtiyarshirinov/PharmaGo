                  ...
                  <tbody>
                    {filteredStock.map((item) => (
                      <tr key={item.id ?? item.stockItemId} className="align-top">
                        <td className="rounded-l-3xl bg-slate-50 px-4 py-4">
                          <div className="space-y-1">
                        ...
                        <td className="rounded-r-3xl bg-slate-50 px-4 py-4">
            ...
            <CardContent className="space-y-3">
              {lowStock.data?.length ? (
                lowStock.data.slice(0, 4).map((item) => (
                  <div key={item.stockItemId} className="rounded-3xl bg-slate-50 p-4">
                    <p className="font-medium text-slate-950">{item.medicineName}</p>
            ...
            <CardContent className="space-y-3">
              {outOfStock.data?.length ? (
                outOfStock.data.slice(0, 4).map((item) => (
                  <div key={`${item.pharmacyId}-${item.medicineId}`} className="rounded-3xl bg-slate-50 p-4">
                    <p className="font-medium text-slate-950">{item.medicineName}</p>
                    <p className="mt-1 text-sm text-slate-500">
